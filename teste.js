...
// Importa o CORS.
// O CORS permite que o frontend hospedado em outro domínio,
// como o Netlify, consiga acessar esta API no Render.
...
// Libera o acesso à API para outros domínios.
// Isso resolve o erro de CORS ao acessar pelo Netlify.
app.use(cors());
...
conexao.connect((erro) => {
  if (erro) {
    console.error('Erro ao conectar ao banco MySQL do Aiven:', erro.message);
    return;
  }

  console.log('Conexão com o banco MySQL do Aiven realizada com sucesso!');
});
...
//
// Exemplo de acesso:
// https://sistema-alunos-notas.onrender.com/teste-banco
